...
def record_audio_and_save(save_path, n_times=200):
    """
...
record_audio_and_save("call/", n_times=200) 


#You have to put in comments the lines 56 & 57 if you just want to record the background sound
